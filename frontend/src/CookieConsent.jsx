...
const CookieConsent = () => {
  ...
  return (
    <div className="z-70 fixed bottom-4 left-4 right-4 md:left-8 md:right-8 bg-gray-800 text-white p-4 rounded-lg shadow-lg flex flex-col md:flex-row items-center justify-between gap-2 md:gap-4 animate-fade-in">
